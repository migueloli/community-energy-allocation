...
public class UserController {
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = "200", description = "User successfully created", content =
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = "200", description = "User successfully retrieved", content =
                    @Content(mediaType = "application/json", schema = @Schema(implementation = UserResponseDTO.class))
                    ),
                    @ApiResponse(
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = "200", description = "User successfully updated", content =
                    @Content(mediaType = "application/json", schema = @Schema(implementation = UserResponseDTO.class))
                    ),
                    @ApiResponse(
                            responseCode = "401", description = "Invalid credentials", content = @Content(
    ...
    public ResponseEntity<UserResponseDTO> updateUser(
            ...
            @Parameter(
                    ...
                    schema =
                    @Schema(implementation = UserUpdateRequestDTO.class)
            )
    ...
    public ResponseEntity<UserResponseDTO> getUserById(
            @Parameter(
                    ...
                    required = true, example = "507f1f77bcf86cd799439011"
